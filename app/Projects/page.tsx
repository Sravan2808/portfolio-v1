      ...
      <div className="border w-fit mx-auto mt-2 border-stone-700 rounded-lg flex p-[1px]">
        <div className="text-center flex items-center justify-center">
          <div
            ...
            className="w-fit flex items-start gap-1 border-2 px-3 py-1 bg-[#d1ccc2]/90 text-[var(--foreground)] border-gray-600 rounded-lg cursor-pointer hover:bg-[#d1ccc2] transition-all duration-300"
          >
